...
export const setTextureUniform = (gl, uniform, texture, unit = 0) => {
  gl.activeTexture(gl.TEXTURE0 + unit);
  gl.bindTexture(gl.TEXTURE_2D, texture);
  gl.uniform1i(uniform, unit);
};

// TODO: Добавить доп. методы с buffer-обёрткой

export const setAttribute = (gl, attr, buffer, typeSize, componentType) => {
...
export const drawElements = (gl, buffer, count, componentType) => {
  ...
  // Эффект каркаса (wireframe) можно добиться с помощью 
